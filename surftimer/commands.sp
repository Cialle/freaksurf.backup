...
public void MiscellaneousOptions(int client)
{
	...
	// Speed Mode
	if (g_SpeedMode[client] == 0)
		AddMenuItem(menu, "", "[xy轴] 速度显示模式");
	else if (g_SpeedMode[client] == 1)
		AddMenuItem(menu, "", "[xyz轴] 速度显示模式");
	else
		AddMenuItem(menu, "", "[Z轴] 速度显示模式");
	...
	if (action == MenuAction_Select)
	{
		switch (param2)
		{
			...
			case 1:
			{
				...
				AddMenuItem(styleSelect2, "5", "慢速模式");
